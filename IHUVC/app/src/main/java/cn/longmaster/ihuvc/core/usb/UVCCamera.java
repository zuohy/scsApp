...
import cn.longmaster.ihuvc.core.usb.USBMonitor.UsbControlBlock;
...
public class UVCCamera {
	...
	public static final int DEFAULT_PREVIEW_WIDTH = 3264;//640
	public static final int DEFAULT_PREVIEW_HEIGHT = 2448;//480
